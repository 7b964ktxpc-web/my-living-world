...
export function makeState({world,objects,selectedId,action,stars=0}){const safeObjects=(objects||[]).map(o=>({id:o.id,type:o.type,label:o.label||o.name,emoji:o.emoji,world:o.world}));return {v:TV_VERSION,type:TV_MESSAGE_TYPES.STATE,ts:Date.now(),payload:{world,objects:safeObjects,selectedId:selectedId||null,action:action||null,stars}}}
